...
class Image {
    ...
    public:
        ...
        void drawPolygon(Polygon polygon, const int* color, int circleRadius = 0) {
            ...
            if (circleRadius) {
                for (int i = 0; i < polygon.length(); i++) {
                    drawPointCircle(polygon.getPoint(i), color, circleRadius);
                }
            }
        }
        ...
        void drawPointCircle(Point p, const int* color, int circleRadius = 2) {
            drawCircle(Circle(p, circleRadius), color);
        }
};